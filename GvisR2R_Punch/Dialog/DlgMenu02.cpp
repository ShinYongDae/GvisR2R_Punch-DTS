...
BOOL CDlgMenu02::Move2PntAlign0(int nPos)
{
	if (pView->m_pMotion->m_dPinPosY[0] > 0.0 && pView->m_pMotion->m_dPinPosX[0] > 0.0)
	{
		...
		if (nPos == 0)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0];
		}
		else if (nPos == 1)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0];
		}
		//if (nPos == 0)
		//{
		//	pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0];
...
BOOL CDlgMenu02::Move4PntAlign0(int nPos)
{
	if (pView->m_pMotion->m_dPinPosY[0] > 0.0 && pView->m_pMotion->m_dPinPosX[0] > 0.0)
	{
		...
		if (nPos == 0)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0];
		}
		else if (nPos == 1)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0];
		}
		else if (nPos == 2)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[0];
		}
		else if (nPos == 3)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[0];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[0];
		}
		//if (nPos == 0)
		//{
		//	pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0];
...
BOOL CDlgMenu02::Move2PntAlign1(int nPos)
{
	if (pView->m_pMotion->m_dPinPosY[1] > 0.0 && pView->m_pMotion->m_dPinPosX[1] > 0.0)
	{
		...
		if (nPos == 0)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1];
		}
		else if (nPos == 1)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1];
		}
		//if (nPos == 0)
		//{
		//	pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1];
...
BOOL CDlgMenu02::Move4PntAlign1(int nPos)
{
	if (pView->m_pMotion->m_dPinPosY[1] > 0.0 && pView->m_pMotion->m_dPinPosX[1] > 0.0)
	{
		...
		if (nPos == 0)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1];
		}
		else if (nPos == 1)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1];
		}
		else if (nPos == 2)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[1];
		}
		else if (nPos == 3)
		{
			pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[1];
			pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[1];
		}
		//if (nPos == 0)
		//{
		//	pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1];
...
void CDlgMenu02::Grab2PntAlign()
{
	...
	pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0];
	pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0];
	pPos[2] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0];
	pPos[3] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0];
	//pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0];
	//pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0];
	//pPos[2] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0];
	//pPos[3] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0];
...
void CDlgMenu02::Grab4PntAlign()
{
	...
	double pPos[8];
	pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0];
	pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[0];
	pPos[2] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0];
	pPos[3] = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0];

	pPos[4] = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[0];
	pPos[5] = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[0];
	pPos[6] = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[0];
	pPos[7] = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[0];
	//pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0];
	//pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[0];
	//pPos[2] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0];
	//pPos[3] = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0];
...
// 	//double dImgPixelRes = pDoc->m_MasterDB.MasterInfo.dPixelSize / 1000.0; // [mm]
// 	double dImgPixelRes = pDoc->m_MasterDB.MasterInfo.dPixelSize / 1000.0; // [mm]
...
void CDlgMenu02::Grab2PntAlign2()
{
	...
	pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1];
	pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1];
	pPos[2] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1];
	pPos[3] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1];
	//pPos[0] = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1];
	//pPos[1] = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1];
	//pPos[2] = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1];
	//pPos[3] = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1];
...
void CDlgMenu02::Grab4PntAlign2()
{
	...
	pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1];
	pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1];
	pPos[2] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1];
	pPos[3] = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[1];

	pPos[4] = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[1];
	pPos[5] = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[1];
	pPos[6] = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[1];
	pPos[7] = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[1];
	//pPos[0] = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1];
	//pPos[1] = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1];
	//pPos[2] = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1];
	//pPos[3] = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[1];
...
BOOL CDlgMenu02::OnePointAlign(CfPoint &ptPnt)
{
	...
	dRefPinX = (double)pDoc->m_MasterDB.m_pCellRgn->nCADPinPosPixX * dResCam;
	dRefPinY = (double)pDoc->m_MasterDB.m_pCellRgn->nCADPinPosPixY * dResCam;
	//dRefPinX = (double)pDoc->m_MasterDB.m_pCellRgn->nCADPinPosPixX * dResCam;
	//dRefPinY = (double)pDoc->m_MasterDB.m_pCellRgn->nCADPinPosPixY * dResCam;
...
BOOL CDlgMenu02::Do2PtAlign0(int nPos, BOOL bDraw)
{
	...
	if (nPos == 1)
	{
		...
		double dRefAlignX0 = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY0 = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX1 = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY1 = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표

																								 // PCB상의 원점 기준의 Marking 이미지 좌표.
		double dTgtAlignX0 = (pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0]) - m_dMkFdOffsetX[0][0];
		double dTgtAlignY0 = (pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0]) - m_dMkFdOffsetY[0][0];
		double dTgtAlignX1 = (pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0]) - dMkFdOffsetX;
		double dTgtAlignY1 = (pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0]) - dMkFdOffsetY;
		//double dRefAlignX0 = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		//double dRefAlignY0 = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		//double dRefAlignX1 = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		//double dRefAlignY1 = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
...
BOOL CDlgMenu02::Do2PtAlign1(int nPos, BOOL bDraw)
{
	...
	if (nPos == 1)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY0 = pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX1 = pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY1 = pDoc->m_MasterDB.m_stAlignMk.Y1 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표

		// PCB상의 원점 기준의 Marking 이미지 좌표.
		double dTgtAlignX0 = (pDoc->m_MasterDB.m_stAlignMk.X0 + pView->m_pMotion->m_dPinPosX[1]) - m_dMkFdOffsetX[1][0];
		double dTgtAlignY0 = (pDoc->m_MasterDB.m_stAlignMk.Y0 + pView->m_pMotion->m_dPinPosY[1]) - m_dMkFdOffsetY[1][0];
		double dTgtAlignX1 = (pDoc->m_MasterDB.m_stAlignMk.X1 + pView->m_pMotion->m_dPinPosX[1]) - dMkFdOffsetX;
...
BOOL CDlgMenu02::Do4PtAlign0(int nPos, BOOL bDraw)
{
	...
	else if (nPos == 3)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY0 = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX1 = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY1 = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX2 = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY2 = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표
		double dRefAlignX3 = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[0]; // PCB좌표
		double dRefAlignY3 = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[0]; // PCB좌표

		// PCB상의 원점 기준의 Marking 이미지 좌표.
		double dTgtAlignX0 = (pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[0]) - m_dMkFdOffsetX[0][0];
		double dTgtAlignY0 = (pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[0]) - m_dMkFdOffsetY[0][0];
		double dTgtAlignX1 = (pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[0]) - m_dMkFdOffsetX[0][1];
		double dTgtAlignY1 = (pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[0]) - m_dMkFdOffsetY[0][1];
		double dTgtAlignX2 = (pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[0]) - m_dMkFdOffsetX[0][2];
		double dTgtAlignY2 = (pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[0]) - m_dMkFdOffsetY[0][2];
		double dTgtAlignX3 = (pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[0]) - m_dMkFdOffsetX[0][3];
...
BOOL CDlgMenu02::Do4PtAlign1(int nPos, BOOL bDraw)
{
	...
	else if (nPos == 3)
	{
		...
		// Cam의 원점 기준의 Marking 이미지 좌표.
		double dRefAlignX0 = pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY0 = pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX1 = pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY1 = pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX2 = pDoc->m_MasterDB.m_stAlignMk2.X2 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY2 = pDoc->m_MasterDB.m_stAlignMk2.Y2 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표
		double dRefAlignX3 = pDoc->m_MasterDB.m_stAlignMk2.X3 + pView->m_pMotion->m_dPinPosX[1]; // PCB좌표
		double dRefAlignY3 = pDoc->m_MasterDB.m_stAlignMk2.Y3 + pView->m_pMotion->m_dPinPosY[1]; // PCB좌표

		// PCB상의 원점 기준의 Marking 이미지 좌표.
		double dTgtAlignX0 = (pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1]) - m_dMkFdOffsetX[1][0];
		double dTgtAlignY0 = (pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1]) - m_dMkFdOffsetY[1][0];
		double dTgtAlignX1 = (pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1]) - m_dMkFdOffsetX[1][1];
		double dTgtAlignY1 = (pDoc->m_MasterDB.m_stAlignMk2.Y1 + pView->m_pMotion->m_dPinPosY[1]) - m_dMkFdOffsetY[1][1];
		double dTgtAlignX2 = (pDoc->m_MasterDB.m_stAlignMk2.X0 + pView->m_pMotion->m_dPinPosX[1]) - m_dMkFdOffsetX[1][2];
		double dTgtAlignY2 = (pDoc->m_MasterDB.m_stAlignMk2.Y0 + pView->m_pMotion->m_dPinPosY[1]) - m_dMkFdOffsetY[1][2];
		double dTgtAlignX3 = (pDoc->m_MasterDB.m_stAlignMk2.X1 + pView->m_pMotion->m_dPinPosX[1]) - m_dMkFdOffsetX[1][3];
